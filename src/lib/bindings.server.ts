...
type AppEnv = {
  ...
  HF_ENV?: string;
  APP_SLUG?: string;
  // Secret impostati con website_secrets: la chiave del pannello e il
  // materiale con cui si firma il cookie di sessione. Mai nel codice.
  PANNELLO_CHIAVE?: string;
  PANNELLO_SESSIONE?: string;
};
